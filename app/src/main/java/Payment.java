...
import com.tanuja.agribuisness.R;

import java.util.ArrayList;

public class Payment extends AppCompatActivity {

    EditText nameEt,upiEt,amountEt;
    Button send;
    String TAG="main";
    ...
    private void payUsingUpi(String amount,String upiId, String name)
    {
        ...
        {
            Toast.makeText(Payment.this, "No UPI app found, please install to continue", Toast.LENGTH_SHORT).show();
        }
