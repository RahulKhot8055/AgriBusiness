...
public class Imageadapter extends PagerAdapter {
    ...
    public Imageadapter(Context Mcontext, List<The_Slide_Items_Model_Class> theSlideItemsModelClassList) {
    ...
    public Object instantiateItem(@NonNull ViewGroup container, int position) {
        ...
        View sliderLayout = inflater.inflate(R.layout.activity_slide_show,null);
